...
document.writeln("                        <dd id='dduser'><a href=\'admin-user.jsp\'>用户管理</a></dd>");
document.writeln("                        <dd id='ddorder'><a href=\'admin-order.jsp\'>订单管理</a></dd>");
// document.writeln("                        <dd id='ddadmin'><a href=\'admin-admin.jsp\'>管理员管理</a></dd>");
document.writeln("                    </dl>");
document.writeln("                </li>");
document.writeln("            </ul>");
