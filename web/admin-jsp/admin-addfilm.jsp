    ...
    <div class="layui-body">
        ...
        <div class="admin_addfilm_maincontainer">
            <form action="/upload" method="post" enctype="multipart/form-data" >
                <input type="file" name="road" placeholder="海报路径" autocomplete="off" class="layui-input" style="width: 500px;">
                <input type="submit" value="上传" style="padding: 2px 5px 2px 5px">
            </form>
            ...
            <form class="layui-form" action="${pageContext.request.contextPath}/add_prefilm.action" method="post">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block" style="width: 500px;">
                        <input id="inputsrc" type="text" name="road" value="${road}" placeholder="海报路径" autocomplete="off"
                               class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
