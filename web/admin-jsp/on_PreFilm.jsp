            ...
            <form class="layui-form" action="${pageContext.request.contextPath}/update_FilmInfo.action" method="post">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block" style="width: 600px;">
                        <input type="checkbox" name="like[love]" title="爱情" value="爱情" <c:if test="${PF.pre_film_type.contains('爱情')}"> checked="checked"</c:if>/>
                        <input type="checkbox" name="like[comedy]" title="喜剧" value="喜剧" <c:if test="${PF.pre_film_type.contains('喜剧')}"> checked="checked"</c:if>/>
                        <input type="checkbox" name="like[animation]" title="动画" value="动画" <c:if test="${PF.pre_film_type.contains('动画')}"> checked="checked"</c:if>/>
                        <input type="checkbox" name="like[story]" title="剧情" value="剧情" <c:if test="${PF.pre_film_type.contains('剧情')}"> checked="checked"</c:if>/>
                        <input type="checkbox" name="like[panic]" title="惊悚" value="惊悚" <c:if test="${PF.pre_film_type.contains('惊悚')}"> checked="checked"</c:if>/>
                        <input type="checkbox" name="like[science]" title="科幻" value="科幻" <c:if test="${PF.pre_film_type.contains('科幻')}"> checked="checked"</c:if>/>
